...
\begin{multicols}{3}
    ...
    \input{1.4-Connectivity.tex}
    \input{1.5-Cycles.tex}
    \input{1.6-Matching.tex}
    \newpage
    \section{Probability Theory}
    \input{2.1-ProbabilityBasics.tex}
    \input{2.2-ConditionalProbability.tex}
    \newpage
    \input{2.3-Independence.tex}
    \input{2.4-RandomVariables.tex}
    % }
\end{multicols}
\end{document}
